  ...
  return (
    ...
    <img className={Style.logoImg} src={NetflixBannerLogo} alt="" />
        ...
        <h1 className={Style.title}>{bannerImage?.original_name}</h1>
            {/* description */}
        <h1 className={Style.description}>{truncate(bannerImage?.overview,140)}</h1>
            {/* buttons */}
           <div className={Style.buttonContainer}>
             <button className={Style.button}> <Play size={30}/>play</button>
            <button className={Style.button}><Info size={30}/>My List</button>
           </div>
        </div >
        {/* fading */}
